    ...
    <div className="chore-form-container">
      ...
      <form onSubmit={handleSubmit} className="chore-form">
        ...
        {category === ChoreCategory.Daily && (
          <div className="form-group">
            <label htmlFor="dayInterval">Repeat every (days):</label>
            <input
              type="number"
              id="dayInterval"
              value={dayInterval}
        ...
        {category === ChoreCategory.Weekly && (
          <div className="form-group">
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginTop: '0.5rem' }}>
              This chore needs to be completed once per week (Monday-Sunday). Complete it any day during the week! ✨
            </p>
          </div>
        )}
        ...
        {category === ChoreCategory.Monthly && (
          <div className="form-group">
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', marginTop: '0.5rem', marginBottom: '1rem' }}>
              This chore needs to be completed once per month. Complete it anytime during the month! ✨
            </p>
